...
import static at.beris.virtualfile.util.DateUtils.*;
...
public class Metadata implements CreativeCommons, Geographic, HttpHeaders,
    ...
    public Integer getInt(Property property) {
        if(property.getPrimaryProperty().getPropertyType() != PropertyType.SIMPLE) {
            return null;
        }
    ...
    public void set(Property property, int value) {
        if(property.getPrimaryProperty().getPropertyType() != PropertyType.SIMPLE) {
            throw new PropertyTypeException(PropertyType.SIMPLE, property.getPrimaryProperty().getPropertyType());
        }
        if(property.getPrimaryProperty().getValueType() != Property.ValueType.INTEGER) {
