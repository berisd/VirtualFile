...
import at.beris.virtualfile.content.detect.TextDetector;
import at.beris.virtualfile.content.detect.XmlRootExtractor;
...
public final class MimeTypes implements Detector, Serializable {
    ...
    public MimeType getMimeType(File file)
        ...
        try (InputStream inputStream = Files.newInputStream(file.toPath())) {
            return forName(detect(inputStream, new Metadata()).toString());
        }
    }
