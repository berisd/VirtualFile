...
/* F- */    (byte) 0xF0, (byte) 0xF1, (byte) 0xF2, (byte) 0xF3, (byte) 0xF4, (byte) 0xF5, (byte) 0xF6, (byte) 0xF7, (byte) 0xF8, (byte) 0xF9, (byte) 0xFA, (byte) 0xFB, (byte) 0xFC, (byte) 0xFD, (byte) 0xFE, (byte) 0xFF,
    ...
    static class CharsetRecog_8859_1 extends CharsetRecog_sbcs {
        ...
        private static CharsetRecog_sbcs.NGramsPlusLang[] ngrams_8859_1 = new CharsetRecog_sbcs.NGramsPlusLang[]{
                new CharsetRecog_sbcs.NGramsPlusLang(
                        "da",
                        new int[]{
        ...
        public CharsetMatch match(CharsetDetector det) {
            ...
            String lang = null;
            for (CharsetRecog_sbcs.NGramsPlusLang ngl : ngrams_8859_1) {
    ...
    static class CharsetRecog_8859_2 extends CharsetRecog_sbcs {
        ...
        private static CharsetRecog_sbcs.NGramsPlusLang[] ngrams_8859_2 = new CharsetRecog_sbcs.NGramsPlusLang[]{
                new CharsetRecog_sbcs.NGramsPlusLang(
                        "cs",
                        new int[]{
        ...
        public CharsetMatch match(CharsetDetector det) {
            ...
            int bestConfidenceSoFar = -1;
            String lang = null;
            for (CharsetRecog_sbcs.NGramsPlusLang ngl : ngrams_8859_2) {
                int confidence = match(det, ngl.fNGrams, byteMap);
                if (confidence > bestConfidenceSoFar) {
                    bestConfidenceSoFar = confidence;
                    lang = ngl.fLang;
...
/* 0xf8-0xff */ (byte) '8', (byte) '9', (byte) 0x20, (byte) 0xfb, (byte) 0xfc, (byte) 0xf9, (byte) 0xfa, (byte) 0x20,
        ...
        static int findLangIndex(String lang) {
            for (int i = 0; i < CharsetRecog_sbcs.CharsetRecog_8859_1.ngrams_8859_1.length; i++) {
                CharsetRecog_sbcs.NGramsPlusLang ngpl = CharsetRecog_sbcs.CharsetRecog_8859_1.ngrams_8859_1[i];
        ...
        public CharsetMatch match(CharsetDetector det) {
            int confidence = match(det, CharsetRecog_sbcs.CharsetRecog_8859_1.ngrams_8859_1[getLangIndex()].fNGrams, byteMap);
            return confidence == 0 ? null : new CharsetMatch(det, this, confidence);
        }
